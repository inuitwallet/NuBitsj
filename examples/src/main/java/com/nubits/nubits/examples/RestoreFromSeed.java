...
public class RestoreFromSeed {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Nubitsj supports hierarchical deterministic wallets (or "HD Wallets"): https://github.com/nubits/bips/blob/master/bip-0032.mediawiki
        // HD wallets allow you to restore your wallet simply from a root seed. This seed can be represented using a short mnemonic sentence as described in BIP 39: https://github.com/nubits/bips/blob/master/bip-0039.mediawiki
        ...
        // You can find some information about this in the guides: https://nubitsj.github.io/working-with-the-wallet#setup
