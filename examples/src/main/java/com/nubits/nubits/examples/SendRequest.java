...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // The Coin class represents a monetary Nubits value.
        ...
        // The Address class represents a Nubits address.
        ...
        // Have a look at the code of the SendRequest class to see what's happening and what other options you have: https://nubitsj.github.io/javadoc/0.11/com/google/nubits/core/Wallet.SendRequest.html
        // 
        ...
        try {
            ...
            // Nubitsj allows you to define a BalanceFuture to execute a callback once your wallet has a certain balance.
            // Here we wait until the we have enough balance and display a notice.
            // Nubitsj is using the ListenableFutures of the Guava library. Have a look here for more information: https://code.google.com/p/guava-libraries/wiki/ListenableFutureExplained
