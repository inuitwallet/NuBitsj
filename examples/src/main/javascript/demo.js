// This file shows how to use nubitsj from Javascript.
// To run, grab the nubitsj bundled JAR and then do something like this:
//
//   jjs -cp nubitsj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp nubitsj-0.12-bundled.jar
//
...
//
//   jjs -cp nubitsj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And nubitsj is a threaded library. This means you
