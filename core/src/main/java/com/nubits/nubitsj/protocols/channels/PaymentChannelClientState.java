...
import com.nubits.nubitsj.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.nubits.nubitsj.core.Wallet.SendRequest)}.
    ...
    public synchronized void provideRefundSignature(byte[] theirSignature) throws VerificationException {
        ...
        TransactionSignature theirSig = TransactionSignature.decodeFromNubits(theirSignature, true);
