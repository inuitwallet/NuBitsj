...
/**
 * <p>Utility methods and constants for working with <a href="https://github.com/nubits/bips/blob/master/bip-0070.mediawiki">
 ...
 * protocol data does not flow over the Nubits P2P network or enter the block chain. It's instead for data that is only
 * of interest to the parties involved but isn't otherwise needed for consensus.</p>
 */
public class PaymentProtocol {

    // MIME types as defined in BIP71.
    public static final String MIMETYPE_PAYMENTREQUEST = "application/nubits-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/nubits-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/nubits-paymentack";
    ...
    public static Protos.Payment createPaymentMessage(List<Transaction> transactions,
        ...
        for (Transaction transaction : transactions) {
            transaction.verify();
            builder.addTransactions(ByteString.copyFrom(transaction.unsafeNubitsSerialize()));
        }
