...
import com.nubits.nubitsj.core.InsufficientMoneyException;
import com.google.common.util.concurrent.ListenableFuture;

import com.google.protobuf.ByteString;
import com.nubits.nubitsj.paymentchannel.Protos;
import com.nubits.nubitsj.paymentchannel.Protos;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.nubits.nubitsj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.nubits.nubitsj.protocols.channels.PaymentChannelCloseException.CloseReason)}
     ...
     * be accepted by the Nubits network. ValueOutOfRangeException will be thrown, however, if there's not enough money
    ...
    interface ClientConnection {
         ...
         * {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link com.nubits.nubitsj.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * will be closed with a  {@link com.nubits.nubitsj.protocols.channels.PaymentChannelCloseException.CloseReason#TIME_WINDOW_UNACCEPTABLE}.</p>
         ...
         * {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient#incrementPayment(java.math.BigInteger)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient}
