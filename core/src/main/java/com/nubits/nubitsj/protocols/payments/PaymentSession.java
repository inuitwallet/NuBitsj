...
import com.nubits.nubitsj.protocols.payments.Protos;
 ...
 *
 * <ul>
 * <li>A {@link NubitsURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a NubitsURI or a url, a network request is made for the payment request object and a
 ...
 * transactions to the nubits network. Instead it returns a ListenableFuture that will be notified when a
 ...
 *
 * @see <a href="https://github.com/nubits/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
     ...
     * uri is a BIP-72-style NubitsURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromNubitsUri(final NubitsURI uri) throws PaymentProtocolException {
        return createFromNubitsUri(uri, true, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromNubitsUri(final NubitsURI uri, final boolean verifyPki)
            throws PaymentProtocolException {
        return createFromNubitsUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromNubitsUri(final NubitsURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in NubitsURI " + uri);
        try {
    ...
    /**
     * Returns the total amount of nubitss requested.
     */
     ...
     * NOTE: This does not broadcast the transactions to the nubits network, it merely sends a Payment message to the
