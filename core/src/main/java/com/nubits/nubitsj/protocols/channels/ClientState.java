...
public final class ClientState {
  ...
  public interface StoredClientPaymentChannelsOrBuilder extends
     ...
     */
    java.util.List<ClientState.StoredClientPaymentChannel>
        getChannelsList();
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
     ...
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    java.util.List<? extends ClientState.StoredClientPaymentChannelOrBuilder>
        getChannelsOrBuilderList();
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    ClientState.StoredClientPaymentChannelOrBuilder getChannelsOrBuilder(
        int index);
  }
  /**
  ...
  public static final class StoredClientPaymentChannels extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                channels_ = new java.util.ArrayList<ClientState.StoredClientPaymentChannel>();
                mutable_bitField0_ |= 0x00000001;
              }
              channels_.add(input.readMessage(ClientState.StoredClientPaymentChannel.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return ClientState.internal_static_paymentchannels_StoredClientPaymentChannels_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ClientState.StoredClientPaymentChannels.class, ClientState.StoredClientPaymentChannels.Builder.class);
    }
    ...
    private java.util.List<ClientState.StoredClientPaymentChannel> channels_;
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public java.util.List<ClientState.StoredClientPaymentChannel> getChannelsList() {
      return channels_;
    }
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public java.util.List<? extends ClientState.StoredClientPaymentChannelOrBuilder>
        getChannelsOrBuilderList() {
      return channels_;
    }
    /**
     ...
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public ClientState.StoredClientPaymentChannelOrBuilder getChannelsOrBuilder(
        int index) {
      return channels_.get(index);
    }
    ...
    public static ClientState.StoredClientPaymentChannels parseFrom(
    ...
    public static ClientState.StoredClientPaymentChannels parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ClientState.StoredClientPaymentChannels parseFrom(
    ...
    public static ClientState.StoredClientPaymentChannels parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ClientState.StoredClientPaymentChannels parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ClientState.StoredClientPaymentChannels parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ClientState.StoredClientPaymentChannels prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using ClientState.StoredClientPaymentChannels.newBuilder()
      private Builder() {
      ...
      public ClientState.StoredClientPaymentChannels getDefaultInstanceForType() {
        return ClientState.StoredClientPaymentChannels.getDefaultInstance();
      }

      public ClientState.StoredClientPaymentChannels build() {
        ClientState.StoredClientPaymentChannels result = buildPartial();
      ...
      public ClientState.StoredClientPaymentChannels buildPartial() {
        ClientState.StoredClientPaymentChannels result = new ClientState.StoredClientPaymentChannels(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ClientState.StoredClientPaymentChannels) {
          return mergeFrom((ClientState.StoredClientPaymentChannels)other);
        } else {
      ...
      public Builder mergeFrom(ClientState.StoredClientPaymentChannels other) {
        if (other == ClientState.StoredClientPaymentChannels.getDefaultInstance()) return this;
        if (channelsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ClientState.StoredClientPaymentChannels parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ClientState.StoredClientPaymentChannels) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private void ensureChannelsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          channels_ = new java.util.ArrayList<ClientState.StoredClientPaymentChannel>(channels_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          ClientState.StoredClientPaymentChannel, ClientState.StoredClientPaymentChannel.Builder, ClientState.StoredClientPaymentChannelOrBuilder> channelsBuilder_;
      ...
      public Builder setChannels(
          int index, ClientState.StoredClientPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChannels(
          int index, ClientState.StoredClientPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public Builder addChannels(ClientState.StoredClientPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllChannels(
          java.lang.Iterable<? extends ClientState.StoredClientPaymentChannel> values) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public ClientState.StoredClientPaymentChannel.Builder getChannelsBuilder(
          int index) {
      ...
      public ClientState.StoredClientPaymentChannel.Builder addChannelsBuilder(
          int index) {
        return getChannelsFieldBuilder().addBuilder(
            index, ClientState.StoredClientPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public java.util.List<ClientState.StoredClientPaymentChannel.Builder>
           getChannelsBuilderList() {
        return getChannelsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ClientState.StoredClientPaymentChannel, ClientState.StoredClientPaymentChannel.Builder, ClientState.StoredClientPaymentChannelOrBuilder>
          getChannelsFieldBuilder() {
        if (channelsBuilder_ == null) {
  ...
  public static final class StoredClientPaymentChannel extends
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ClientState.internal_static_paymentchannels_StoredClientPaymentChannel_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ClientState.StoredClientPaymentChannel.class, ClientState.StoredClientPaymentChannel.Builder.class);
    }
    ...
    public static ClientState.StoredClientPaymentChannel parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ClientState.StoredClientPaymentChannel parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static ClientState.StoredClientPaymentChannel parseFrom(
    ...
    public static ClientState.StoredClientPaymentChannel parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ClientState.StoredClientPaymentChannel parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(ClientState.StoredClientPaymentChannel prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      // Construct using ClientState.StoredClientPaymentChannel.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public ClientState.StoredClientPaymentChannel getDefaultInstanceForType() {
        return ClientState.StoredClientPaymentChannel.getDefaultInstance();
      }

      public ClientState.StoredClientPaymentChannel build() {
        ClientState.StoredClientPaymentChannel result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public ClientState.StoredClientPaymentChannel buildPartial() {
        ClientState.StoredClientPaymentChannel result = new ClientState.StoredClientPaymentChannel(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ClientState.StoredClientPaymentChannel) {
          return mergeFrom((ClientState.StoredClientPaymentChannel)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ClientState.StoredClientPaymentChannel other) {
        if (other == ClientState.StoredClientPaymentChannel.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ClientState.StoredClientPaymentChannel parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ClientState.StoredClientPaymentChannel) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
