...
public final class ServerState {
  ...
  public interface StoredServerPaymentChannelsOrBuilder extends
     ...
     */
    java.util.List<ServerState.StoredServerPaymentChannel>
        getChannelsList();
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
     ...
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    java.util.List<? extends ServerState.StoredServerPaymentChannelOrBuilder>
        getChannelsOrBuilderList();
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    ServerState.StoredServerPaymentChannelOrBuilder getChannelsOrBuilder(
        int index);
  }
  /**
  ...
  public static final class StoredServerPaymentChannels extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                channels_ = new java.util.ArrayList<ServerState.StoredServerPaymentChannel>();
                mutable_bitField0_ |= 0x00000001;
              }
              channels_.add(input.readMessage(ServerState.StoredServerPaymentChannel.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return ServerState.internal_static_paymentchannels_StoredServerPaymentChannels_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ServerState.StoredServerPaymentChannels.class, ServerState.StoredServerPaymentChannels.Builder.class);
    }
    ...
    private java.util.List<ServerState.StoredServerPaymentChannel> channels_;
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public java.util.List<ServerState.StoredServerPaymentChannel> getChannelsList() {
      return channels_;
    }
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public java.util.List<? extends ServerState.StoredServerPaymentChannelOrBuilder>
        getChannelsOrBuilderList() {
      return channels_;
    }
    /**
     ...
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public ServerState.StoredServerPaymentChannelOrBuilder getChannelsOrBuilder(
        int index) {
      return channels_.get(index);
    }
    ...
    public static ServerState.StoredServerPaymentChannels parseFrom(
    ...
    public static ServerState.StoredServerPaymentChannels parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ServerState.StoredServerPaymentChannels parseFrom(
    ...
    public static ServerState.StoredServerPaymentChannels parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ServerState.StoredServerPaymentChannels parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ServerState.StoredServerPaymentChannels parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ServerState.StoredServerPaymentChannels prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using ServerState.StoredServerPaymentChannels.newBuilder()
      private Builder() {
      ...
      public ServerState.StoredServerPaymentChannels getDefaultInstanceForType() {
        return ServerState.StoredServerPaymentChannels.getDefaultInstance();
      }

      public ServerState.StoredServerPaymentChannels build() {
        ServerState.StoredServerPaymentChannels result = buildPartial();
      ...
      public ServerState.StoredServerPaymentChannels buildPartial() {
        ServerState.StoredServerPaymentChannels result = new ServerState.StoredServerPaymentChannels(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ServerState.StoredServerPaymentChannels) {
          return mergeFrom((ServerState.StoredServerPaymentChannels)other);
        } else {
      ...
      public Builder mergeFrom(ServerState.StoredServerPaymentChannels other) {
        if (other == ServerState.StoredServerPaymentChannels.getDefaultInstance()) return this;
        if (channelsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ServerState.StoredServerPaymentChannels parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ServerState.StoredServerPaymentChannels) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private void ensureChannelsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          channels_ = new java.util.ArrayList<ServerState.StoredServerPaymentChannel>(channels_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          ServerState.StoredServerPaymentChannel, ServerState.StoredServerPaymentChannel.Builder, ServerState.StoredServerPaymentChannelOrBuilder> channelsBuilder_;
      ...
      public Builder setChannels(
          int index, ServerState.StoredServerPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChannels(
          int index, ServerState.StoredServerPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public Builder addChannels(ServerState.StoredServerPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllChannels(
          java.lang.Iterable<? extends ServerState.StoredServerPaymentChannel> values) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public ServerState.StoredServerPaymentChannel.Builder getChannelsBuilder(
          int index) {
      ...
      public ServerState.StoredServerPaymentChannel.Builder addChannelsBuilder(
          int index) {
        return getChannelsFieldBuilder().addBuilder(
            index, ServerState.StoredServerPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public java.util.List<ServerState.StoredServerPaymentChannel.Builder>
           getChannelsBuilderList() {
        return getChannelsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ServerState.StoredServerPaymentChannel, ServerState.StoredServerPaymentChannel.Builder, ServerState.StoredServerPaymentChannelOrBuilder>
          getChannelsFieldBuilder() {
        if (channelsBuilder_ == null) {
  ...
  public static final class StoredServerPaymentChannel extends
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ServerState.internal_static_paymentchannels_StoredServerPaymentChannel_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ServerState.StoredServerPaymentChannel.class, ServerState.StoredServerPaymentChannel.Builder.class);
    }
    ...
    public static ServerState.StoredServerPaymentChannel parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ServerState.StoredServerPaymentChannel parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ServerState.StoredServerPaymentChannel parseFrom(
    ...
    public static ServerState.StoredServerPaymentChannel parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static ServerState.StoredServerPaymentChannel parseFrom(
    ...
    public static ServerState.StoredServerPaymentChannel parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ServerState.StoredServerPaymentChannel parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(ServerState.StoredServerPaymentChannel prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      // Construct using ServerState.StoredServerPaymentChannel.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public ServerState.StoredServerPaymentChannel getDefaultInstanceForType() {
        return ServerState.StoredServerPaymentChannel.getDefaultInstance();
      }

      public ServerState.StoredServerPaymentChannel build() {
        ServerState.StoredServerPaymentChannel result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public ServerState.StoredServerPaymentChannel buildPartial() {
        ServerState.StoredServerPaymentChannel result = new ServerState.StoredServerPaymentChannel(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ServerState.StoredServerPaymentChannel) {
          return mergeFrom((ServerState.StoredServerPaymentChannel)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ServerState.StoredServerPaymentChannel other) {
        if (other == ServerState.StoredServerPaymentChannel.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ServerState.StoredServerPaymentChannel parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ServerState.StoredServerPaymentChannel) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
