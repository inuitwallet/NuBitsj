...
public class PaymentChannelClient implements IPaymentChannelClient {
    ...
    @Nullable
    @GuardedBy("lock")
    private PaymentChannelCloseException.CloseReason receiveInitiate(Protos.Initiate initiate, Coin contractValue, Protos.Error.Builder errorBuilder) throws VerificationException, InsufficientMoneyException, IOException {
        ...
        Protos.ProvideRefund.Builder provideRefundBuilder = Protos.ProvideRefund.newBuilder()
                ...
                .setTx(ByteString.copyFrom(state.getIncompleteRefundTransaction().nubitsSerialize()));
    ...
    private void receiveRefund(Protos.TwoWayChannelMessage refundMsg) throws VerificationException {
        ...
        Protos.ProvideContract.Builder contractMsg = Protos.ProvideContract.newBuilder()
                .setTx(ByteString.copyFrom(state.getMultisigContract().nubitsSerialize()));
        try {
            ...
            initialMsg.setSignature(ByteString.copyFrom(payment.signature.encodeToNubits()));
    ...
    public void receiveMessage(Protos.TwoWayChannelMessage msg) throws InsufficientMoneyException {
        ...
        try {
            ...
            PaymentChannelCloseException.CloseReason closeReason = null;
            try {
                switch (msg.getType()) {
                    case Protos.TwoWayChannelMessage.MessageType.SERVER_VERSION:
                        ...
                        return;
                    case Protos.TwoWayChannelMessage.MessageType.INITIATE:
                        ...
                        break;
                    case Protos.TwoWayChannelMessage.MessageType.RETURN_REFUND:
                        receiveRefund(msg);
                        return;
                    case Protos.TwoWayChannelMessage.MessageType.CHANNEL_OPEN:
                        receiveChannelOpen();
                        return;
                    case Protos.TwoWayChannelMessage.MessageType.PAYMENT_ACK:
                    ...
                    case Protos.TwoWayChannelMessage.MessageType.ERROR:
                        ...
                        conn.destroyConnection(PaymentChannelCloseException.CloseReason.REMOTE_SENT_ERROR);
                        return;
                    default:
    ...
    private void receiveClose(Protos.TwoWayChannelMessage msg) throws VerificationException {
        ...
        if (step == InitStep.WAITING_FOR_CHANNEL_CLOSE)
            conn.destroyConnection(PaymentChannelCloseException.CloseReason.CLIENT_REQUESTED_CLOSE);
        else
            conn.destroyConnection(PaymentChannelCloseException.CloseReason.SERVER_REQUESTED_CLOSE);
     ...
     * {@link ClientConnection#destroyConnection(PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link ClientConnection#destroyConnection(PaymentChannelCloseException.CloseReason)} to settle the connection, it does not
