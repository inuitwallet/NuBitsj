...
import com.nubits.nubitsj.net.ProtobufParser;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link com.nubits.nubitsj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
