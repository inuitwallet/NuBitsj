...
/**
 * <p>This class, a concrete extension of {@link NbtFormat}, is distinguished in that each
 * instance formats and by-default parses all Nubits monetary values in units of a single
 ...
 * {@link NbtFormat} class, and further information beyond that is in the documentation for the
...
public final class NbtFixedFormat extends NbtFormat {
     ...
     *  thet same value expressed in nubitss. */
    private final int scale;

    /** Constructor */
    protected NbtFixedFormat(
     ...
     * the denomination is millinubitss, this method will return the value <code>3</code>.  As
     ...
     *  the denomination is millinubitss, this method will return the value <code>3</code>.  */
    @Override
     ...
     * denomination is millinubitss, then this method will return <code>"mNbt"</code>,
     * assuming the default base currency-code is not overridden using a
     * {@link NbtFormat.Builder}.  */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof NbtFixedFormat)) return false;
        NbtFixedFormat other = (NbtFixedFormat)o;
