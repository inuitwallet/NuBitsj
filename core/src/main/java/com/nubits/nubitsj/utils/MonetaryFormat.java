...
import com.nubits.nubitsj.shapeshift.ShapeShiftMonetary;
import com.nubits.nubitsj.shapeshift.ShapeShiftMonetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the NBT denomination. */
    public static final MonetaryFormat NBT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 Nubits. */
    public static final String CODE_NBT = "NBT";
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for Nubits
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard NBT notation that was
    ...
    /**
     * Parse a human readable coin value to a {@link com.nubits.nubitsj.core.Coin} instance.
     * 
    ...
    /**
     * Gets a {@link ShapeShiftMonetary} for a string formatted with the MonetaryFormat
     *
