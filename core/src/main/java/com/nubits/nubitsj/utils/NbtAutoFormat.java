...
import static com.nubits.nubitsj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link NbtFormat}, is distinguished by its
 * accommodation of multiple denominational units as follows:
 *
 * <p>When formatting Nubits monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing <code>String</code> representations of Nubits monetary values, instances of
 ...
 * NbtFormat} class, and further information beyond that is in the documentation for the {@link
...
public final class NbtAutoFormat extends NbtFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "Nbt". */
        CODE {
        ...
        /** Constant for the formatting style that uses a currency symbol, e.g., "𝘕". */
        SYMBOL {
            @Override void apply(DecimalFormat decimalFormat) {
    ...
    /** Constructor */
    protected NbtAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    /**
     * Calculate the appropriate denomination for the given Nubits monetary value.  This
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof NbtAutoFormat)) return false;
        return super.equals((NbtAutoFormat)o);
    }
