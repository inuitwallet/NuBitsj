...
/**
 * A collection of various utility methods that are helpful for working with the Nubits protocol.
 * To enable debug logging from the library, run with -Dnubitsj.logging=true on your command line.
 */
public class Utils {
    ...
    /** The string that prefixes all text messages signed using Nubits keys. */
    public static final String Nubits_SIGNED_MESSAGE_HEADER = "Nubits Signed Message:\n";
    public static final byte[] Nubits_SIGNED_MESSAGE_HEADER_BYTES = Nubits_SIGNED_MESSAGE_HEADER.getBytes(Charsets.UTF_8);
     ...
     * standard procedure in Nubits. The resulting hash is in big endian form.
     */
     ...
     *
     * <p>Nubits only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
     ...
     *
     * <tt><p>[24] "Nubits Signed Message:\n" [message.length as a varint] message</p></tt>
     */
    public static byte[] formatMessageForSigning(String message) {
        try {
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            bos.write(Nubits_SIGNED_MESSAGE_HEADER_BYTES.length);
            bos.write(Nubits_SIGNED_MESSAGE_HEADER_BYTES);
