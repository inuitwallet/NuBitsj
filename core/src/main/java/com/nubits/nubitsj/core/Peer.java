...
import com.nubits.nubitsj.net.AbstractTimeoutHandler;
...
/**
 * <p>A Peer handles the high level communication with a Nubits node, extending a {@link PeerSocketHandler} which
 * handles low-level message (de)serialization.</p>
 *
 * <p>Note that timeouts are handled by the extended
 * {@link com.nubits.nubitsj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.nubits.nubitsj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that nubits-qt is single threaded and processes messages in order.
     ...
     * {@link com.nubits.nubitsj.net.NioClientManager#openConnection(java.net.SocketAddress, com.nubits.nubitsj.net.StreamParser)}
     * or
     * {@link com.nubits.nubitsj.net.NioClient#NioClient(java.net.SocketAddress, com.nubits.nubitsj.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // nubitsj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public void setDownloadParameters(long secondsSinceEpoch, boolean useFilteredBlocks) {
    	// For nubits we cannot use filtered blocks until the protocol has been upgraded
        lock.lock();
        try {
     ...
     * Once the pong is received the value returned by {@link com.nubits.nubitsj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.nubits.nubitsj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.nubits.nubitsj.core.Peer#ping()} has never
