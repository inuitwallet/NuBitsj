...
public class BloomFilter extends Message {
     ...
     * See {@link com.nubits.nubitsj.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    /**
     * Serializes this message to the provided stream. If you just want the raw bytes use nubitsSerialize().
     */
    @Override
    ...
    /**
     * Returns true if this filter will match anything. See {@link com.nubits.nubitsj.core.BloomFilter#setMatchAll()}
            ...
            for (ScriptChunk chunk : script.getChunks()) {
                ...
                if (contains(chunk.data)) {
                    ...
                    if (flag == BloomUpdate.UPDATE_ALL || (flag == BloomUpdate.UPDATE_P2PUBKEY_ONLY && isSendingToPubKeys))
                        insert(output.getOutPointFor().nubitsSerialize());
                    found = true;
                }
            }
        }
