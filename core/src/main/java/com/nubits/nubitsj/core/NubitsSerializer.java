...
import static com.nubits.nubitsj.core.Utils.*;

/**
 * <p>Methods to serialize and de-serialize messages to the Nubits network format as defined in
 * <a href="https://en.nubits.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.nubitsSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class NubitsSerializer {
    private static final Logger log = LoggerFactory.getLogger(NubitsSerializer.class);
    ...
    /**
     * Constructs a NubitsSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public NubitsSerializer(NetworkParameters params) {
     ...
     */
    public NubitsSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("NubitsSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.nubitsSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Nubits protocol message has the following format.
        //
        ...
        NubitsPacketHeader header = new NubitsPacketHeader(in);
     ...
     */
    public NubitsPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new NubitsPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link NubitsSerializer#deserializeHeader}.
     */
    public Message deserializePayload(NubitsPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class NubitsPacketHeader {
        ...
        public NubitsPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
