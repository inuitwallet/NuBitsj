...
import com.nubits.nubitsj.net.MessageWriteTarget;
...
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
    ...
    private NubitsSerializer.NubitsPacketHeader header;
    ...
    public PeerSocketHandler(NetworkParameters params, InetSocketAddress remoteIp) {
        serializer = new NubitsSerializer(checkNotNull(params));
     ...
     * called automatically by {@link com.nubits.nubitsj.net.NioClient} or
     * {@link com.nubits.nubitsj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
