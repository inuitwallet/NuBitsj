...
import com.nubits.nubitsj.wallet.KeyChainEventListener;
import com.nubits.nubitsj.script.Script;
import com.nubits.nubitsj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.nubits.nubitsj.core.Transaction#getConfidence()}. It's safe to modify the
