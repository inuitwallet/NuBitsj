...
import static com.nubits.nubitsj.core.Utils.isLessThanUnsigned;
import static com.nubits.nubitsj.core.Utils.isLessThanOrEqualToUnsigned;
...
public class VarInt {
    ...
    // Nubits has its own varint format, known in the C++ source as "compact size".
