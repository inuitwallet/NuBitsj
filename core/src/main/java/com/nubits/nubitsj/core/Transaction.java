...
public class Transaction extends ChildMessage implements Serializable {
    ...
    public boolean isMature() {
        ...
        if (getConfidence().getConfidenceType() != TransactionConfidence.ConfidenceType.BUILDING)
            return false;
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, Script, ECKey, com.nubits.nubitsj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.nubits.nubitsj.core.Transaction.SigHash, boolean)}
