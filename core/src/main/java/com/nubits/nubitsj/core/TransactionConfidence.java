...
import com.nubits.nubitsj.utils.ListenerRegistration;
import com.nubits.nubitsj.utils.Threading;
import com.nubits.nubitsj.wallet.CoinSelector;
 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.nubits.nubitsj.core.TransactionConfidence#notifyWorkDone(Block)}
 * method to ensure the block depth and work done are up to date.</p>
 * To make a copy that won't be changed, use {@link com.nubits.nubitsj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence implements Serializable {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.nubits.nubitsj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        public enum ChangeReason {
            /**
             * Occurs when the type returned by {@link com.nubits.nubitsj.core.TransactionConfidence#getConfidenceType()}
