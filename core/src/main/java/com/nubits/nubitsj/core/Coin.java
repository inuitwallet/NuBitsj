...
import com.nubits.nubitsj.utils.MonetaryFormat;
...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * Number of decimals for one Nubits. This constant is useful for quick adapting to other coins because a lot of
    ...
    /**
     * 0.01 Nubitss. This unit is not really used much.
     */
    public static final Coin CENT = COIN.divide(100);

    /**
     * 0.001 Nubitss, also known as 1 mNBT.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 Nubits, also known as 1 µNBT or 1 uNBT.
     */
    public static final Coin MICROCOIN = MILLICOIN.divide(1000);

    /**
     * A satoshi is the smallest unit that can be transferred. 1 million of them fit into a Nubits.
     */
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.NBT.minDecimals(2).repeatOptionalDecimals(1, 2).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.NBT.minDecimals(0).repeatOptionalDecimals(1, 4).noCode();
