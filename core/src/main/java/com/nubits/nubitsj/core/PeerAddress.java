...
import static com.nubits.nubitsj.core.Utils.uint32ToByteStreamLE;
import static com.nubits.nubitsj.core.Utils.uint64ToByteStreamLE;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * A PeerAddress holds an IP address and port number representing the network location of
 * a peer in the Nubits P2P network. It exists primarily for serialization purposes.
 */
public class PeerAddress extends ChildMessage {
    ...
    public static final int INC_TIME_PROTOCOL = 31402;
    ...
    public PeerAddress(InetAddress addr, int port, int protocolVersion) {
        ...
        length = protocolVersion >= INC_TIME_PROTOCOL ? MESSAGE_SIZE : MESSAGE_SIZE - 4;
    }
    ...
    protected void nubitsSerializeToStream(OutputStream stream) throws IOException {
        if (protocolVersion >= INC_TIME_PROTOCOL) {
