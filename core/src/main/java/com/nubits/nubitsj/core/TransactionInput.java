...
import com.nubits.nubitsj.wallet.DefaultRiskAnalysis;
...
public class TransactionInput extends ChildMessage implements Serializable {
    ...
    protected void nubitsSerializeToStream(OutputStream stream) throws IOException {
        outpoint.nubitsSerialize(stream);
     ...
     * "from address" is not well defined in Nubits and you should not assume that senders of a transaction can
    ...
    public TransactionInput duplicateDetached() {
        return new TransactionInput(params, null, nubitsSerialize(), 0);
    }
