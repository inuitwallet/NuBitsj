...
public class Sha256Hash implements Serializable, Comparable<Sha256Hash> {
    ...
    /**
     * Calculates the hash of the hash of the contents. This is a standard operation in Nubits.
     */
    ...
    @Override
    public int hashCode() {
        // Use the last 4 bytes, not the first 4 which are often zeros in Nubits.
