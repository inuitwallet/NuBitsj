...
import com.nubits.nubitsj.protocols.channels.StoredPaymentChannelServerStates;
 ...
 * It is to make it easier to fit nubitsj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing nubitsj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the nubitsj website for further details.
     */
