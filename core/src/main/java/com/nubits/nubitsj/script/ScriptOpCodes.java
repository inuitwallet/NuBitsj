...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Nubits protocol.
 * See {@link com.nubits.nubitsj.script.Script} for details. Also provides a method to convert them to a string.
 */
