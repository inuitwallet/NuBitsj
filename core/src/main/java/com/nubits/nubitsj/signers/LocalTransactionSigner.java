...
import com.nubits.nubitsj.core.ScriptException;
import com.nubits.nubitsj.core.Transaction;
import com.nubits.nubitsj.core.TransactionInput;
...
import com.nubits.nubitsj.wallet.KeyBag;
import com.nubits.nubitsj.wallet.RedeemData;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link com.nubits.nubitsj.wallet.KeyBag}.</p>
 ...
 * <p>This signer always uses {@link com.nubits.nubitsj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            try {
                ...
                int sigIndex = 0;
                inputScript = scriptPubKey.getScriptSigWithSignature(inputScript, signature.encodeToNubits(), sigIndex);
