...
import com.nubits.nubitsj.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#nubits" or "#nubitsTEST3" for the production and test networks
     *                respectively.
     */
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // nubitsj but not match the standard nick format, so full peers don't try and connect to us.
    ...
    static ArrayList<InetSocketAddress> parseUserList(String[] userNames) throws UnknownHostException {
        ...
        for (String user : userNames) {
            // All Nubits peers start their nicknames with a 'u' character.
            ...
            try {
                ...
                // so simply beginning with "u" does not imply this is a valid Nubits encoded address.
                //
