...
/**
 * SeedPeers stores a pre-determined list of Nubits node addresses. These nodes are selected based on being
 * active on the network for a long period of time. The intention is to be a last resort way of finding a connection
 * to the network, in case IRC and DNS fail. The list comes from the Nubits C++ source code.
 */
public class SeedPeers implements PeerDiscovery {
    ...
    /**
     * Returns an array containing all the Nubits nodes within the list.
     */
    @Override
