...
import com.nubits.nubitsj.core.*;
import com.nubits.nubitsj.crypto.KeyCrypter;
...
import com.nubits.nubitsj.wallet.KeyChainGroup;
import com.nubits.nubitsj.wallet.WalletTransaction;
 ...
 * format is defined by the <tt>wallet.proto</tt> file in the nubitsj source distribution.<p>
 *
...
public class WalletProtobufSerializer {
    ...
    private void readTransaction(Protos.Transaction txProto, NetworkParameters params) throws UnreadableWalletException {
        ...
        if (txProto.hasPurpose()) {
            switch (txProto.getPurpose()) {
                case Protos.Transaction.Purpose.UNKNOWN: tx.setPurpose(Transaction.Purpose.UNKNOWN); break;
                case Protos.Transaction.Purpose.USER_PAYMENT: tx.setPurpose(Transaction.Purpose.USER_PAYMENT); break;
                case Protos.Transaction.Purpose.KEY_ROTATION: tx.setPurpose(Transaction.Purpose.KEY_ROTATION); break;
                case Protos.Transaction.Purpose.ASSURANCE_CONTRACT_CLAIM: tx.setPurpose(Transaction.Purpose.ASSURANCE_CONTRACT_CLAIM); break;
                case Protos.Transaction.Purpose.ASSURANCE_CONTRACT_PLEDGE: tx.setPurpose(Transaction.Purpose.ASSURANCE_CONTRACT_PLEDGE); break;
                case Protos.Transaction.Purpose.ASSURANCE_CONTRACT_STUB: tx.setPurpose(Transaction.Purpose.ASSURANCE_CONTRACT_STUB); break;
    ...
    private WalletTransaction connectTransactionOutputs(Protos.Transaction txProto) throws UnreadableWalletException {
        ...
        switch (txProto.getPool()) {
            case Protos.Transaction.Pool.DEAD: pool = WalletTransaction.Pool.DEAD; break;
            case Protos.Transaction.Pool.PENDING: pool = WalletTransaction.Pool.PENDING; break;
            case Protos.Transaction.Pool.SPENT: pool = WalletTransaction.Pool.SPENT; break;
            case Protos.Transaction.Pool.UNSPENT: pool = WalletTransaction.Pool.UNSPENT; break;
    ...
    private void readConfidence(Transaction tx, Protos.TransactionConfidence confidenceProto,
        ...
        switch (confidenceProto.getType()) {
            case Protos.TransactionConfidence.Type.BUILDING: confidenceType = TransactionConfidence.ConfidenceType.BUILDING; break;
            case Protos.TransactionConfidence.Type.DEAD: confidenceType = TransactionConfidence.ConfidenceType.DEAD; break;
            // These two are equivalent (must be able to read old wallets).
            case Protos.TransactionConfidence.Type.NOT_IN_BEST_CHAIN: confidenceType = TransactionConfidence.ConfidenceType.PENDING; break;
            case Protos.TransactionConfidence.Type.PENDING: confidenceType = TransactionConfidence.ConfidenceType.PENDING; break;
            case Protos.TransactionConfidence.Type.UNKNOWN:
                // Fall through.
            default:
                confidenceType = TransactionConfidence.ConfidenceType.UNKNOWN; break;
        }
        ...
        switch (confidenceProto.getSource()) {
            case Protos.TransactionConfidence.Source.SOURCE_SELF: confidence.setSource(TransactionConfidence.Source.SELF); break;
            case Protos.TransactionConfidence.Source.SOURCE_NETWORK: confidence.setSource(TransactionConfidence.Source.NETWORK); break;
