...
import com.nubits.nubitsj.core.StoredBlock;
import com.nubits.nubitsj.core.StoredTransactionOutput;
import com.nubits.nubitsj.core.StoredUndoableBlock;
 ...
 * Nubits serialization of the block header, <b>not</b> the header with the extra data as well.</p>
 * 
 * <p>A FullPrunedBlockStore also contains a map of hash+index to StoredTransactionOutput.  Again, the hash is
 * a standard Nubits double-SHA256 hash of the transaction.</p>
 *
