 ...
 * so you can use {@link #calculateBalanceForAddress(com.nubits.nubitsj.core.Address)} to quickly look up
 * the quantity of nubitss controlled by that address.</p>
 */
public class PostgresFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    private void putUpdateStoredBlock(StoredBlock storedBlock, boolean wasUndoable) throws SQLException {
        try {
            ...
            s.setBytes(4, storedBlock.getHeader().unsafeNubitsSerialize());
