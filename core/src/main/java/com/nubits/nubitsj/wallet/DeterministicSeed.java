...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.nubits.nubitsj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.nubits.nubitsj.crypto.MnemonicException if check fails
     */
