...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link com.nubits.nubitsj.core.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the nubitsj protobuf format. */
     ...
     *
     * <p>See the docs for {@link com.nubits.nubitsj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
