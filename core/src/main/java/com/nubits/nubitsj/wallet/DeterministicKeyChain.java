/**
 * Copyright 2013 The peercoinj developers.
 *
 ...
 * <a href="https://github.com/nubits/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
 * {@link com.nubits.nubitsj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.nubits.nubitsj.crypto.MnemonicCode},
 ...
 * {@link com.nubits.nubitsj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.nubits.nubitsj.crypto.DeterministicKey#deserializeB58(com.nubits.nubitsj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.nubits.nubitsj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.nubits.nubitsj.crypto.DeterministicHierarchy} and
 * {@link com.nubits.nubitsj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from nubitsj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.nubits.nubitsj.crypto.DeterministicKey)}
