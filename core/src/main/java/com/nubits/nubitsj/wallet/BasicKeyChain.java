...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.nubits.nubitsj.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.nubits.nubitsj.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.nubits.nubitsj.crypto.KeyCrypter,
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all nubits controlled by that private key is lost forever).
