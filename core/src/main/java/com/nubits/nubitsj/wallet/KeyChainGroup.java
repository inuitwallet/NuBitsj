...
/**
 * <p>A KeyChainGroup is used by the {@link com.nubits.nubitsj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     * <p>IMPORTANT: As of Nubits Core 0.9 all multisig transactions which require more than 3 public keys are non-standard
    ...
    public void markP2SHAddressAsUsed(Address address) {
        ...
        checkArgument(address.isSelectedP2SHAddress());
     ...
     * {@link com.nubits.nubitsj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.nubits.nubitsj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.nubits.nubitsj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.nubits.nubitsj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
