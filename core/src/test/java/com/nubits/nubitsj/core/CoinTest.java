...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 NBT", COIN.toFriendlyString());
        assertEquals("1.23 NBT", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 NBT", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 NBT", valueOf(1, 23).negate().toFriendlyString());
    }
