...
import com.nubits.nubitsj.crypto.EncryptedData;
...
import com.nubits.nubitsj.wallet.Protos.ScryptParameters;
...
import static com.nubits.nubitsj.core.Utils.reverseBytes;
...
public class ECKeyTest {
    ...
    public void base58Encoding() throws Exception {
        String addr = "BFWurfWeUxtKyTY5x6exr2iUP9N3Yf4MLe";
        String privkey = "VJXpuMxCPFda77VaLtJzsz3RNQ6QKkshV9UWtLKTYEx7piBdzPAS";
    ...
    public void base58Encoding_leadingZero() throws Exception {
        String privkey = "7QHESQo3EXrEfiKvfhjuaCxjefFkMA6eYJ1CD4ypqeA3qmrvGV7";
        ECKey key = new DumpedPrivateKey(MainNetParams.get(), privkey).getKey();
        assertEquals(privkey, key.getPrivateKeyEncoded(MainNetParams.get()).toString());
    ...
    public void base58Encoding_stress() throws Exception {
        ...
        for (int i = 0 ; i < 20 ; i++) {
            ECKey key = new ECKey();
            ECKey key1 = new DumpedPrivateKey(MainNetParams.get(),
